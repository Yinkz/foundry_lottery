...
contract RaffleTest is Test{
    ...
    function testEmitInventOnEntrance() public {
        vm.prank(PLAYER);
    ...
    function CannotEnterWhenRaffleIsCalculating() public {
        vm.prank(PLAYER);
        raffle.enterRaffle{value: entranceFee}();
    ...
    function testFulfillRandomWordsCanOnlyBeCalledAfterPerformUpkeep(uint256 randomRequestId) raffleEnteredAndTimePassed{
    ...
    function testFulfillRandomWordsPicksAWinnerResetsAndSendMoney() public raffleEnteredAndTimePassed skipFork{
        ...
        assert(reffle.getRecentWinner() != address(0));
